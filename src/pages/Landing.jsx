  ...
  return (
    ...
    <div className=''>
        ...
        <div className="p-3 row ">
          ...
          <Link to={'/home'} className="d-flex justify-content-center justify-content-md-start text-decoration-none w-100 w-sm-50">
          <button className='btn bg-warning text-white fw-bold my-2 p-2 w-100'>Get Started</button>
          </Link>
          </div>
          <div className="right col-lg-6 d-flex justify-content-center align-items-center">
            <img src="https://i.gifer.com/Up2T.gif" className='d-none d-md-block' width={300} height={300} alt="mainImage" style={{scale:1.1,borderRadius:"50%"}}/>
          </div>
        </div>
        <Cards/>
