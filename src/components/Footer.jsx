...
const Footer = () => {
  return (
    <div className='row'>
        ...
        <div className="right-section col-lg-6 col-sm-12 row py-3 gap-3 gap-sm-0">
            <div className="link col-md-4 text-center text-md-start d-flex flex-column align-items-center">
            ...
            <div className="link col-md-4 text-center text-md-start d-flex flex-column align-items-center">
              ...
              <div className="input d-flex flex-column align-items-center">
                <div className="d-flex gap-1 justify-content-center justify-content-lg-start align-items-center">
                ...
                <div className="icons d-flex gap-4 mt-3 justify-content-center justify-content-md-start">
            ...
            <p className="mt-3 text-center">copyright &copy; julay 2025, media player , built with react</p>
    </div>
  )
}
